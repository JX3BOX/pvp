...
<script>
import { getBread } from "@/service/pvp/raw";
import xfMap from "@jx3box/jx3box-data/data/xf/xf.json";
import desertXfMap from "@/assets/data/pvp/desertXf.json";
import { iconLink } from "@jx3box/jx3box-common/js/utils";
import { showMountIcon } from "@jx3box/jx3box-common/js/utils";
import { getBuff } from "@/service/pvp/cj";
...
export default {
    ...
    computed: {
        ...
        currentLogo() {
            ...
            return {
                src: id !== null ? this.showMountIcon(id) : require("@/assets/img/pvp/logo.svg"),
