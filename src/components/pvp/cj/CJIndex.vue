...
import { getMapList, getPoints, addPoint, getMyPoints, delPoint, updatePoint, reviewPoint } from "@/service/pvp/cj";
import jx3boxData from "@jx3box/jx3box-common/data/jx3box.json";
import mapPath from "@/assets/data/pvp/mapPath.json";
import mapPath_origin from "@/assets/data/pvp/mapPath_origin.json";
import { cloneDeep, pick } from "lodash";
import User from "@jx3box/jx3box-common/js/user.js";
import { formatTime } from "@/utils";
import { legends, statusMap, getPointInfo } from "@/assets/data/pvp/desertPoints";
...
<style lang="less">
@import "~@/assets/css/pvp/cj/index.less";
</style>
