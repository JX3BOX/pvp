    ...
    <div class="m-rank-ladder-mini" v-loading="loading">
        <div class="m-ladder-header">
            <h3 class="m-ladder-title">
                <span class="u-title">
                    <img class="u-icon" svg-inline src="@/assets/img/pvp/side/rank.svg" /> 竞技场热门榜
                </span>
...
import { getRankList, createRankItem, putRankList, delRankList, getRankItem } from "@/service/pvp/rank.js";
...
import { getConfigBanner } from "@/service/pvp/raw.js";
import User from "@jx3box/jx3box-common/js/user.js";
import draggable from "vuedraggable";
import rankMap from "@/assets/data/pvp/rankMap.json";
...
<style lang="less">
@import "~@/assets/css/pvp/rank.less";
</style>
