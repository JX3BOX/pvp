            ...
            <div class="m-martial-skills" v-loading="loading">
                ...
                <div class="m-martial-skill" v-for="(kungfu_row, kungfu_id) in kungfu_skills" :key="kungfu_id">
                    ...
                    <div class="u-title">
                        ...
                        <img src="@/assets/img/pvp/skillset.png" class="u-title-img" alt="" />
                    </div>
                    <!-- 套路技能 -->
                    <div class="m-skills">
                        <template v-for="(kungfu_item, index) in kungfu_row" :key="index">
                            <template v-if="index > 0 && clientOptionVal != 'wujie'">
                                <div class="m-connect" v-if="kungfu_row[index - 1].skill_id == kungfu_item.prev">
                                    <img class="u-img" src="@/assets/img/pvp/arrow.png" />
                                </div>
                            </template>
                            <div
                                class="m-skill"
                                        ...
                                        >
                                            <div class="m-skill-icon">
                                                ...
                                                <img
                                                    ...
                                                    "
                                                    class="u-icon"
                                                    src="@/assets/img/pvp/challenge.png"
                                                ...
                                                <img
                                                    ...
                                                    class="u-icon-audio"
                                                    src="@/assets/img/pvp/audio_icon.png"
                                                ...
                                                <img
                                                    ...
                                                    "
                                                    src="@/assets/img/pvp/skill_switch.png"
                                                    @click.stop="
...
<script>
import { getKungfuPanel } from "@/service/pvp/node";
import { ref } from "vue";
import { groupBy } from "lodash";
import SkillItemV2 from "@/components/pvp/SkillItemV2.vue";

import { useStore } from "@/pages/pvp/store";

import xfmap from "@jx3box/jx3box-data/data/xf/xf.json";
import { getTalents, getBreadcrumb, getSkillAudios } from "@/service/pvp/raw";
import { iconLink, showMountIcon } from "@jx3box/jx3box-common/js/utils";
import { getRecipe } from "@/service/pvp/node";
...
import SkillWiki from "@/components/pvp/skill/SkillWiki.vue";
import TalentRecommend from "@/components/pvp/skill/TalentRecommend.vue";
import SpecialSkill from "@/components/pvp/skill/SpecialSkills.vue";
import SkillAudio from "@/components/pvp/skill/SkillAudio.vue";
...
export default {
    ...
    computed: {
        ...
        zhenfaBg() {
            ...
            return {
                "background-image": `url(${require(`@/assets/img/pvp/matrix/${school}.png`)})`,
            };
        },
        // 奇穴id std
...
<style lang="less">
@import "~@/assets/css/pvp/martial.less";
.p-martial-content {
    display: flex;
